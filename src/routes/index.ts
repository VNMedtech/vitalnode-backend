...
import { sellerAddressRouter } from "../modules/sellerAddresses/routes/sellerAddress.routes.js";
...
apiRouter.use("/seller/addresses", sellerAddressRouter);
