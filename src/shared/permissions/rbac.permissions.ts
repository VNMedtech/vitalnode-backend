...
export const permissions = {
  ...
  sellerAddresses: {
    read: "seller-addresses:read",
    create: "seller-addresses:create",
    update: "seller-addresses:update",
    delete: "seller-addresses:delete",
    setDefault: "seller-addresses:set-default",
  },
  cart: {
    read: "cart:read",
    mutate: "cart:mutate",
...
export const rolePermissions: Record<UserRole, readonly Permission[]> = {
  ...
  [UserRole.SELLER]: [
    ...
    permissions.sellerAddresses.update,
    permissions.sellerAddresses.delete,
